const services = [
  {
    ...
    features: ['Up to 2 hours of coverage', '100+ edited photos and videos', 'Private online gallery', 'Download access for clients'],
  },
  {
    ...
    features: ['Up to 4 hours of coverage', '3-5 minute highlight film', 'Full ceremony recording', 'Cinematic color grading'],
  },
  {
