          ...
          <div className="glass-card rounded-xl p-8 w-full max-w-md" onClick={(e) => e.stopPropagation()}>
            {step === 'saving' ? (
              ...
              <>
                ...
                <p className="text-muted text-sm mb-6">{files.length} file{files.length > 1 ? 's' : ''} selected. Fill in the gallery details to continue.</p>
                <div className="space-y-4 mb-6">
                  ...
                  <div>
                    <label className="block text-xs text-silver mb-1.5">Event / Gallery Name *</label>
                    <input value={eventName} onChange={(e) => setEventName(e.target.value)} className={inputClass} placeholder="e.g. Wedding Photos" />
                  </div>
                  <div>
